...
- “提取关键帧”、”视频截图”、”帧提取”、”视频切片” → **必须先读** `video-frames/SKILL.md`

**会话管理类：**
- **”导出聊天记录”、”导出当前聊天”、”导出对话记录”、”聊天记录导出”、”生成聊天日志”、”打包聊天记录”、”导出后台日志”、”生成调试报告”** → **必须先读** `session-debug-export/SKILL.md`，导出的是 OpenClaw agent 会话记录，不是飞书平台聊天记录
