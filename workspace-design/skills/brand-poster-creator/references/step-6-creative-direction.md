...
| 维度 | 内容 |
|------|------|
| 这张海报想表达 | [summary，简短一句话] |
| 场景概念 | [scene_concept，简短描述] |
| 视觉主体 | [hero_focus，简短描述] |
| 必须打中 | [must_hit，用逗号分隔] |
| 必须避免 | [must_avoid，用逗号分隔] |
...
🔴 **关键要点**（确保成功）：
1. **第1行**：艾特标签 + 一句话说明
2. **第3行**：立即开始 Markdown 表格
3. **表格简化**：只保留5行核心信息，不要展开详细内容
4. **总长度**：整个消息不超过15行（参考文案审批的长度）
5. **回复选项**：极度简化，一行搞定
