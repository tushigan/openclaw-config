...
ROLE_ARGS = {
    ...
    "camera_storyboard_reference": "camera_storyboard_reference",
    ...
    "package_material_reference": "package_material_reference",
    "texture_identity_reference": "texture_identity_reference",
