...
// 测试配置
const ENDPOINTS = [
  { name: 'aixor.org', url: 'https://aixor.org/v1/chat/completions' },
  { name: 'cn.aixor.org', url: 'https://cn.aixor.org/v1/v1/chat/completions' }
];
...
if (!API_KEY) {
  ...
  console.error('使用方式：');
  console.error('  AIXOR_API_KEY=your_key node test-aixor-endpoints.js');
  console.error('  或者：node test-aixor-endpoints.js your_key');
  process.exit(1);
}
