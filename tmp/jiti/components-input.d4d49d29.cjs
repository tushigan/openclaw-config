...
class Input {
  ...
  invalidate() {
    ...
    const totalWidth = (0, _utils.visibleWidth)(this.value);
    ...
    } else
    {
      ...
      const cursorCol = (0, _utils.visibleWidth)(this.value.slice(0, this.cursor));
      if (scrollWidth > 0) {
        ...
        if (cursorCol > totalWidth - halfWidth) {
          // Cursor near end
        ...
        visibleText = (0, _utils.sliceByColumn)(this.value, startCol, scrollWidth, true);
        const beforeCursor = (0, _utils.sliceByColumn)(this.value, startCol, Math.max(0, cursorCol - startCol), true);
...
}exports.Input = Input; /* v9-66f8e84ef31f8541 */
