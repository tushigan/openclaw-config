"use strict";Object.defineProperty(exports, "__esModule", { value: true });exports.es_AR = es_AR; // deno-fmt-ignore-file
// deno-coverage-ignore-start
/** Spanish (Argentina) - ISO 639-1 language code 'es' with ISO 3166-1 alpha-2 country code 'AR' for Argentina. */
function es_AR(error) {
...
// deno-coverage-ignore-stop /* v9-04bafd9b66eb1a81 */
