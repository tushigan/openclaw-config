"use strict";Object.defineProperty(exports, "__esModule", { value: true });exports.BuildMaxContains = BuildMaxContains;exports.CheckMaxContains = CheckMaxContains;exports.ErrorMaxContains = ErrorMaxContains;
...
function BuildMaxContains(stack, context, schema, value) {
  ...
  return _index2.EmitGuard.IsLessEqualThan(count, _index2.EmitGuard.Constant(schema.maxContains));
}
// ------------------------------------------------------------------
// Check
// ------------------------------------------------------------------
function CheckMaxContains(stack, context, schema, value) {
  ...
  return _index2.Guard.IsLessEqualThan(count, schema.maxContains);
}
// ------------------------------------------------------------------
// Error
// ------------------------------------------------------------------
