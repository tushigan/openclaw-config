"use strict";Object.defineProperty(exports, "__esModule", { value: true });exports.validateToolArguments = validateToolArguments;exports.validateToolCall = validateToolCall;var _compile = require("typebox/compile");
var _value = require("typebox/value");
...
function getValidator(schema) {
  ...
  const validator = (0, _compile.Compile)(schema);
...
function validateToolArguments(tool, toolCall) {
  ...
  _value.Value.Convert(tool.parameters, args);
