 ...
 */class ExtensionSelectorComponent extends _piTui.Container {options;selectedIndex = 0;
  ...
  constructor(title, options, onSelect, onCancel, opts) {
    ...
    if (opts?.timeout && opts.timeout > 0 && opts.tui) {
      this.countdown = new _countdownTimer.CountdownTimer(opts.timeout, opts.tui, (s) => this.titleText.setText(_theme.theme.fg("accent", _theme.theme.bold(`${this.baseTitle} (${s}s)`))), () => this.onCancelCallback());
    }
...
}exports.ExtensionSelectorComponent = ExtensionSelectorComponent; /* v9-a5848790d28db95d */
