"use strict";Object.defineProperty(exports, "__esModule", { value: true });exports.n = listKnownChannelEnvVarNames;exports.t = getChannelEnvVars;var _pluginMetadataSnapshotMEvRUosy = require("./plugin-metadata-snapshot-mEvRUosy.js");
...
function resolveChannelEnvVars(params) {
  const snapshot = (0, _pluginMetadataSnapshotMEvRUosy.r)({
