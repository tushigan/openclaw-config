...
class Editor {
  ...
  handleInput(data) {
    ...
    if (this.jumpMode !== null) {
      ...
      const printable = (0, _keys.decodePrintableKey)(data) ?? (data.charCodeAt(0) >= 32 ? data : undefined);
    ...
    const printable = (0, _keys.decodePrintableKey)(data);
    if (printable !== undefined) {
...
}exports.Editor = Editor; /* v9-40ef538e93e4699e */
