"use strict";Object.defineProperty(exports, "__esModule", { value: true });exports.a = stripDowngradedToolCallText;exports.c = stripToolCallXmlTags;exports.d = stripModelSpecialTokens;exports.f = findCodeRegions;exports.i = stripAssistantInternalScaffolding;exports.l = hasOrphanReasoningCloseBoundary;exports.n = sanitizeAssistantVisibleTextWithOptions;exports.o = stripLegacyBracketToolCallBlocks;exports.p = isInsideCode;exports.r = sanitizeAssistantVisibleTextWithProfile;exports.s = stripMinimaxToolCallXml;exports.t = sanitizeAssistantVisibleText;exports.u = stripReasoningTagsFromText;var _stringCoerceBje8XVt = require("./string-coerce-Bje8XVt9.js");
var _toolPayloadC9IkpcXW = require("./tool-payload-C9IkpcXW.js");
...
function parseToolCallTagAt(text, start) {
  ...
  const tagName = (0, _stringCoerceBje8XVt.a)(text.slice(nameStart, cursor));
...
function stripDowngradedToolCallText(text) {
  ...
  const stripToolCalls = (input) => {
    ...
    for (const match of input.matchAll(toolCallRe)) {
      ...
      while (index < input.length && (input[index] === " " || input[index] === "	")) index += 1;
      if ((0, _stringCoerceBje8XVt.a)(input.slice(index, index + 9)) === "arguments") {
        index += 9;
...
function applyAssistantVisibleTextStagePipeline(text, options) {
  ...
  const stripNonReasoningStages = (value) => {
    ...
    cleaned = (0, _toolPayloadC9IkpcXW.r)(cleaned);
