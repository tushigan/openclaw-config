...
var _containerEnvironmentFaFSjZpP = require("./container-environment-FaFSjZpP.js");
var _tailnetBixs7ChM = require("./tailnet-Bixs7ChM.js");
...
function pickPrimaryLanIPv4() {
  return (0, _tailnetBixs7ChM.i)((0, _tailnetBixs7ChM.a)(), {
    family: "IPv4",
...
function isPrivateOrLoopbackAddress(ip) {
  return (0, _ip9c4ODEZi.d)(ip);
}
function normalizeIp(ip) {
  return (0, _ip9c4ODEZi.p)(ip);
}
...
function isTrustedProxyAddress(ip, trustedProxies) {
  ...
  return trustedProxies.some((proxy) => {
    ...
    return (0, _ip9c4ODEZi.o)(normalized, candidate);
  });
}
...
async function resolveGatewayBindHost(bind, customHost) {
  ...
  if (mode === "tailnet") {
    const tailnetIP = (0, _tailnetBixs7ChM.n)();
  ...
  if (mode === "auto") {
    if ((0, _containerEnvironmentFaFSjZpP.t)()) return "0.0.0.0";
    if (await canBindToHost("127.0.0.1")) return "127.0.0.1";
    return "0.0.0.0";
  }
  return "0.0.0.0";
...
function defaultGatewayBindMode(tailscaleMode) {
  ...
  return (0, _containerEnvironmentFaFSjZpP.t)() ? "auto" : "loopback";
}
/**
