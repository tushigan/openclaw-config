"use strict";Object.defineProperty(exports, "__esModule", { value: true });exports.id_ID = id_ID; // deno-fmt-ignore-file
// deno-coverage-ignore-start
/** Indonesian (Indonesia) - ISO 639-1 language code 'id' with ISO 3166-1 alpha-2 country code 'ID' for Indonesia. */
function id_ID(error) {
...
// deno-coverage-ignore-stop /* v9-252644e8436aa3b5 */
