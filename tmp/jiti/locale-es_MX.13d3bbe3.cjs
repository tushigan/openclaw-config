"use strict";Object.defineProperty(exports, "__esModule", { value: true });exports.es_MX = es_MX; // deno-fmt-ignore-file
// deno-coverage-ignore-start
/**  Spanish (Mexico) - ISO 639-1 language code 'es' with ISO 3166-1 alpha-2 country code 'MX' for Mexico. */
function es_MX(error) {
...
// deno-coverage-ignore-stop /* v9-11cd24bcad25ee39 */
