"use strict";Object.defineProperty(exports, "__esModule", { value: true });exports.Hash = Hash;exports.HashCode = HashCode;
var _index = require("../unreachable/index.mjs");
...
function FromValue(value) {
  return _index2.GlobalsGuard.IsTypeArray(value) ? FromTypeArray(value) :
  _index2.GlobalsGuard.IsDate(value) ? FromDate(value) :
  _index2.GlobalsGuard.IsRegExp(value) ? FromRegExp(value) :
  _index2.GlobalsGuard.IsBoolean(value) ? FromBoolean(value.valueOf()) :
  _index2.GlobalsGuard.IsString(value) ? FromString(value.valueOf()) :
  _index2.GlobalsGuard.IsNumber(value) ? FromNumber(value.valueOf()) :
  IsIEEE754(value) ? FromNumber(value) :
  _index2.Guard.IsArray(value) ? FromArray(value) :
  _index2.Guard.IsBoolean(value) ? FromBoolean(value) :
  _index2.Guard.IsBigInt(value) ? FromBigInt(value) :
  _index2.Guard.IsConstructor(value) ? FromConstructor(value) :
  _index2.Guard.IsNull(value) ? FromNull(value) :
  _index2.Guard.IsObject(value) ? FromObject(value) :
  _index2.Guard.IsString(value) ? FromString(value) :
  _index2.Guard.IsSymbol(value) ? FromSymbol(value) :
  _index2.Guard.IsUndefined(value) ? FromUndefined(value) :
  _index2.Guard.IsFunction(value) ? FromFunction(value) :
