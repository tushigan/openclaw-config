"use strict";Object.defineProperty(exports, "__esModule", { value: true });exports.i = sweepExpiredPluginStateEntries;exports.n = closePluginStateSqliteStore;exports.r = isPluginStateDatabaseOpen;exports.t = createPluginStateKeyedStore;var _pathsC1_Y0cDn = require("./paths-C1_Y0cDn.js");
var _sqliteWalDmwGqLNY = require("./sqlite-wal-DmwGqLNY.js");
...
function resolvePluginStateDir(env = process.env) {
  return _nodePath.default.join((0, _pathsC1_Y0cDn.v)(env), "plugin-state");
}
...
function openPluginStateDatabase(operation = "open") {
  ...
  try {
    ...
    const walMaintenance = (0, _sqliteWalDmwGqLNY.t)(db);
