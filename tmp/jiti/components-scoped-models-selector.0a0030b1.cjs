...
class ScopedModelsSelectorComponent extends _piTui.Container {
  ...
  constructor(config, callbacks) {
    ...
    this.addChild(new _piTui.Text(_theme.theme.fg("muted", `Session-only. ${(0, _keybindingHints.keyText)("app.models.save")} to save to settings.`), 0, 0));
    this.addChild(new _piTui.Spacer(1));
    // Search input
...
}exports.ScopedModelsSelectorComponent = ScopedModelsSelectorComponent; /* v9-958f17c9d11ba779 */
