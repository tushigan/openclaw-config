"use strict";Object.defineProperty(exports, "__esModule", { value: true });exports.a = normalizeAssistantPhase;exports.c = resolveAssistantMessagePhase;exports.i = extractFirstTextBlock;exports.n = extractAssistantTextForPhase;exports.o = parseAssistantTextSignature;exports.r = extractAssistantVisibleText;exports.s = resolveAssistantEventPhase;exports.t = encodeAssistantTextSignature;var _stringCoerceBje8XVt = require("./string-coerce-Bje8XVt9.js");
//#region src/shared/chat-message-content.ts
function extractFirstTextBlock(message) {
  if (!message || typeof message !== "object") return;
  const content = message.content;
  const inline = (0, _stringCoerceBje8XVt.f)(content);
  if (inline !== void 0) return inline;
  if (!Array.isArray(content) || content.length === 0) return;
  const first = content[0];
  if (!first || typeof first !== "object") return;
  return (0, _stringCoerceBje8XVt.f)(first.text);
}
