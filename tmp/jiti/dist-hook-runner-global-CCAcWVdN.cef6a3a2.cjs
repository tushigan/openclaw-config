"use strict";Object.defineProperty(exports, "__esModule", { value: true });exports.a = resetGlobalHookRunner;exports.c = fireAndForgetBoundedHook;exports.i = initializeGlobalHookRunner;exports.l = fireAndForgetHook;exports.n = getGlobalPluginRegistry;exports.o = runGlobalGatewayStopSafely;exports.r = hasGlobalHooks;exports.s = joinPresentTextSegments;exports.t = getGlobalHookRunner;exports.u = formatHookErrorForLog;var _errorsQN8rySzW = require("./errors-QN8rySzW.js");
...
const getFireAndForgetHookState = () => (0, _globalSingletonDZyLAEQq.n)(Symbol.for("openclaw.fireAndForgetHookState"), () => ({
  active: 0,
  queue: []
}));
...
function formatHookErrorForLog(err) {
  return (replaceLogControlCharacters((0, _errorsQN8rySzW.i)(err)).replace(/\s+/g, " ").trim() || "unknown error").slice(0, MAX_HOOK_LOG_MESSAGE_LENGTH);
}
function fireAndForgetHook(task, label, logger = _globalsCZuktVBk.r) {
  task.catch((err) => {
...
function fireAndForgetBoundedHook(task, label, logger = _globalsCZuktVBk.r, options = {}) {
...
function createHookRunner(registry, options = {}) {
  ...
  const sanitizeHookError = (error) => {
    return (0, _errorsQN8rySzW.i)(error).split("\n")[0]?.trim() || "unknown error";
  };
...
const getState = () => (0, _globalSingletonDZyLAEQq.n)(hookRunnerGlobalStateKey, () => ({
  hookRunner: null,
  registry: null
}));
const getLog = () => (0, _subsystemCxWoQXRD.t)("plugins");
/**
