...
class UserMessageSelectorComponent extends _piTui.Container {
  ...
  constructor(messages, onSelect, onCancel, initialSelectedId) {
    ...
    this.addChild(new _piTui.Text(_theme.theme.fg("muted", "Select a user message to copy the active path up to that point into a new session"), 1, 0));
    this.addChild(new _piTui.Spacer(1));
...
}exports.UserMessageSelectorComponent = UserMessageSelectorComponent; /* v9-a18173e04e53f794 */
