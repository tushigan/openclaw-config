"use strict";Object.defineProperty(exports, "__esModule", { value: true });exports.i = resolveActiveTalkProviderConfig;exports.n = normalizeTalkConfig;exports.r = normalizeTalkSection;exports.t = buildTalkConfigResponse;var _stringCoerceBje8XVt = require("./string-coerce-Bje8XVt9.js");
...
function normalizeTalkSecretInput(value) {
  ...
  return (0, _typesSecretsCL51SR4g.o)(value) ?? void 0;
}
...
function activeProviderFromTalk(talk) {
  const provider = (0, _stringCoerceBje8XVt.c)(talk.provider);
...
function normalizeTalkSection(value) {
  ...
  const source = value;
  const normalized = {};
  const speechLocale = (0, _stringCoerceBje8XVt.c)(source.speechLocale);
  ...
  const provider = (0, _stringCoerceBje8XVt.c)(source.provider);
...
function buildTalkConfigResponse(value) {
  ...
  const activeProvider = (0, _stringCoerceBje8XVt.c)(normalized?.provider) ?? resolved?.provider;
