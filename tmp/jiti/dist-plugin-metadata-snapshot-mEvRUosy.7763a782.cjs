"use strict";Object.defineProperty(exports, "__esModule", { value: true });exports.a = resolvePluginControlPlaneFingerprint;exports.c = isDiagnosticsTimelineEnabled;exports.i = fingerprintPluginDiscoveryContext;exports.n = listPluginOriginsFromMetadataSnapshot;exports.o = resolvePluginDiscoveryContext;exports.r = loadPluginMetadataSnapshot;exports.s = emitDiagnosticsTimelineEvent;exports.t = isPluginMetadataSnapshotCompatible;var _envCHKgtsNu = require("./env-CHKgtsNu.js");
var _diagnosticFlagsCkplz1Fx = require("./diagnostic-flags-Ckplz1Fx.js");
...
function isDiagnosticsTimelineEnabled(options = {}) {
  ...
  return ((0, _diagnosticFlagsCkplz1Fx.t)("timeline", config, env) || (0, _diagnosticFlagsCkplz1Fx.t)("diagnostics.timeline", config, env) || (0, _envCHKgtsNu.t)(env.OPENCLAW_DIAGNOSTICS)) && typeof env.OPENCLAW_DIAGNOSTICS_TIMELINE_PATH === "string" && env.OPENCLAW_DIAGNOSTICS_TIMELINE_PATH.trim().length > 0;
}
...
function emitDiagnosticsTimelineEvent(event, options = {}) {
  ...
  try {
    ...
    (0, _nodeFs.appendFileSync)(path, line, "utf8");
  } catch (error) {
...
function fingerprintPluginDiscoveryContext(context) {
  return (0, _installedPluginIndexStoreDH9sPamj.y)(context);
}
function resolvePluginControlPlaneContext(params = {}) {
  const inventoryFingerprint = params.inventoryFingerprint ?? (params.index ? (0, _manifestRegistryInstalled5Jxol4QJ.n)(params.index) : void 0);
  return {
    discovery: resolvePluginDiscoveryContext(params),
    policyFingerprint: params.policyHash ?? (0, _installedPluginIndexStoreDH9sPamj._)(params.config),
...
function indexesMatch(left, right) {
  ...
  return (0, _manifestRegistryInstalled5Jxol4QJ.n)(left) === (0, _manifestRegistryInstalled5Jxol4QJ.n)(right);
}
...
function isPluginMetadataSnapshotCompatible(params) {
  ...
  return params.snapshot.policyHash === (0, _installedPluginIndexStoreDH9sPamj._)(params.config) && (!params.snapshot.configFingerprint || params.snapshot.configFingerprint === resolvePluginMetadataControlPlaneFingerprint({
...
function loadPluginMetadataSnapshotImpl(params) {
  ...
  const registryResult = (0, _pluginRegistryCutMFnk.m)({
    config: params.config,
    workspaceDir: params.workspaceDir,
  ...
  const manifestRegistry = index.plugins.length === 0 ? (0, _manifestRegistryBiAsJcRZ.t)({
    config: params.config,
    workspaceDir: params.workspaceDir,
    env: params.env,
    diagnostics: [...index.diagnostics],
    installRecords: index.installRecords
  }) : (0, _manifestRegistryInstalled5Jxol4QJ.t)({
    index,
    config: params.config,
    workspaceDir: params.workspaceDir,
    env: params.env,
  ...
  const normalizePluginId = (0, _pluginRegistryCutMFnk.g)(index, { manifestRegistry });
