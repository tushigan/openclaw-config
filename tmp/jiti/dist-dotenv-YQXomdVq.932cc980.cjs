"use strict";Object.defineProperty(exports, "__esModule", { value: true });exports.n = loadGlobalRuntimeDotEnvFiles;exports.r = loadWorkspaceDotEnvFile;exports.t = loadDotEnv;var _homeDirG5LU3LmA = require("./home-dir-g5LU3LmA.js");
...
const logger = (0, _subsystemCxWoQXRD.t)("infra:dotenv");
...
function loadGlobalRuntimeDotEnvFiles(opts) {
  ...
  const stateEnvPath = opts?.stateEnvPath ?? _nodePath.default.join((0, _utilsD5swhEXt.d)(process.env), ".env");
  const defaultStateEnvPath = _nodePath.default.join((0, _homeDirG5LU3LmA.o)(process.env, _nodeOs.default.homedir), ".openclaw", ".env");
  ...
  if (!hasExplicitNonDefaultStateDir) parsedFiles.push(readDotEnvFile({
    filePath: _nodePath.default.join((0, _homeDirG5LU3LmA.o)(process.env, _nodeOs.default.homedir), ".config", "openclaw", "gateway.env"),
    shouldBlockKey: shouldBlockRuntimeDotEnvKey,
    quiet
  }));
