"use strict";Object.defineProperty(exports, "__esModule", { value: true });exports.a = decodeWindowsOutputBuffer;exports.i = createWindowsOutputDecoder;exports.n = resolveCommandStdio;exports.o = resolveWindowsConsoleEncoding;exports.r = spawnWithFallback;exports.t = resolveWindowsCommandShim;var _stringCoerceBje8XVt = require("./string-coerce-Bje8XVt9.js");
...
function decodeWindowsOutputBuffer(params) {
  ...
  if (!encoding || (0, _stringCoerceBje8XVt.a)(encoding) === "utf-8") return params.buffer.toString("utf8");
  try {
...
function createWindowsOutputDecoder(params) {
  ...
  const normalizedEncoding = (0, _stringCoerceBje8XVt.a)(encoding);
...
function resolveWindowsCommandShim(params) {
  ...
  const basename = (0, _stringCoerceBje8XVt.a)(_nodePath.default.basename(params.command));
