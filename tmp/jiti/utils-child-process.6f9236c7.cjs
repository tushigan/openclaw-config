"use strict";Object.defineProperty(exports, "__esModule", { value: true });exports.shouldUseWindowsShell = shouldUseWindowsShell;exports.waitForChildProcess = waitForChildProcess;var _nodePath = require("node:path");
const EXIT_STDIO_GRACE_MS = 100;
const WINDOWS_SHELL_COMMANDS = new Set(["npm", "npx", "pnpm", "yarn", "yarnpkg", "corepack"]);
function shouldUseWindowsShell(command) {
  if (process.platform !== "win32")
  return false;
  const commandName = (0, _nodePath.basename)(command).toLowerCase();
