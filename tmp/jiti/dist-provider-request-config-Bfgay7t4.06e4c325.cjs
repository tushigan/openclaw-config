"use strict";Object.defineProperty(exports, "__esModule", { value: true });exports.a = mergeModelProviderRequestOverrides;exports.c = resolveProviderRequestHeaders;exports.d = sanitizeConfiguredProviderRequest;exports.f = sanitizeRuntimeProviderRequestOverrides;exports.i = getModelProviderRequestTransport;exports.l = resolveProviderRequestPolicyConfig;exports.n = buildProviderRequestDispatcherPolicy;exports.o = normalizeBaseUrl;exports.r = buildProviderRequestTlsClientOptions;exports.s = resolveProviderRequestConfig;exports.t = attachModelProviderRequestTransport;exports.u = sanitizeConfiguredModelProviderRequest;var _stringCoerceBje8XVt = require("./string-coerce-Bje8XVt9.js");
...
function isLoopbackProviderBaseUrl(baseUrl) {
  ...
  try {
    ...
    return host === "localhost" || host.endsWith(".localhost") || (0, _ip9c4ODEZi.u)(host);
  } catch {
    return false;
  }
}
...
function mergeProviderRequestHeaders(...headerSets) {
  ...
  for (const headers of headerSets) {
    ...
    for (const [key, value] of Object.entries(headers)) {
      const normalizedKey = (0, _stringCoerceBje8XVt.a)(key);
...
function applyResolvedAuthHeader(headers, auth) {
  ...
  const keysToDelete = new Set([(0, _stringCoerceBje8XVt.a)(auth.headerName)]);
  if (auth.mode === "header") keysToDelete.add("authorization");
  for (const key of Object.keys(next)) if (keysToDelete.has((0, _stringCoerceBje8XVt.a)(key))) delete next[key];
...
function resolveProviderRequestPolicyConfig(params) {
  ...
  const policy = (0, _providerAttributionDaSNL9Cf.i)(policyInput);
  ...
  const protectedAttributionKeys = new Set(Object.keys(policy.attributionHeaders ?? {}).map((key) => (0, _stringCoerceBje8XVt.a)(key)));
  const unprotectedCallerHeaders = params.callerHeaders ? Object.fromEntries(Object.entries(params.callerHeaders).filter(([key]) => !protectedAttributionKeys.has((0, _stringCoerceBje8XVt.a)(key)))) : void 0;
