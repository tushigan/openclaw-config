...
class SettingsManager {
  ...
  static create(cwd, agentDir = (0, _config.getAgentDir)()) {
  ...
  getSessionDir() {
    ...
    if (sessionDir.startsWith("~/")) {
      return (0, _path.join)((0, _os.homedir)(), sessionDir.slice(2));
    }
    return sessionDir;
  }
  getDefaultProvider() {
...
}exports.SettingsManager = SettingsManager; /* v9-c9ea6ee7418cf074 */
