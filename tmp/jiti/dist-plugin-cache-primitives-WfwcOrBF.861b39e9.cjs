"use strict";Object.defineProperty(exports, "__esModule", { value: true });exports.i = resolveConfigScopedRuntimeCacheValue;exports.n = createConfigScopedPromiseLoader;exports.r = createPluginCacheKey;exports.t = void 0; //#region src/plugins/plugin-cache-primitives.ts
...
function createConfigScopedPromiseLoader(load) {
  ...
  const createPromise = (config) => {
    ...
    promise.catch(() => {
      if (config) promisesByConfig.delete(config);else
      if (defaultPromise === promise) defaultPromise = void 0;
    });
    return promise;
  };
  return {
