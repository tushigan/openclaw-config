"use strict";Object.defineProperty(exports, "__esModule", { value: true });exports.formatDimensionNote = formatDimensionNote;exports.resizeImage = resizeImage;var _exifOrientation = require("./exif-orientation.js");
...
async function resizeImage(img, options) {
  ...
  try {
    ...
    image = (0, _exifOrientation.applyExifOrientation)(photon, rawImage, inputBytes);
    if (image !== rawImage)
    rawImage.free();
