"use strict";Object.defineProperty(exports, "__esModule", { value: true });exports.i = shouldUseSyntheticOllamaAuth;exports.n = void 0;exports.r = resolveOllamaDiscoveryResult;exports.t = void 0;var _defaultsB6UFvvXy = require("./defaults-B6UFvvXy.js");
var _providerBaseUrlBdKwtJTo = require("./provider-base-url-BdKwtJTo.js");
...
function hasExplicitRemoteOllamaApiProvider(providers) {
  ...
  for (const [providerId, provider] of Object.entries(providers)) {
    ...
    const baseUrl = (0, _providerBaseUrlBdKwtJTo.t)(provider);
...
function shouldUseSyntheticOllamaAuth(providerConfig) {
  ...
  return isLocalOllamaBaseUrl((0, _providerBaseUrlBdKwtJTo.t)(providerConfig));
}
function hasMeaningfulExplicitOllamaConfig(providerConfig) {
  ...
  const baseUrl = (0, _providerBaseUrlBdKwtJTo.t)(providerConfig);
  if (baseUrl) return (0, _providerBaseUrlBdKwtJTo.u)(baseUrl) !== _defaultsB6UFvvXy.n;
...
async function resolveOllamaDiscoveryResult(params) {
  ...
  if (hasExplicitModels && explicit) {
    const baseUrl = (0, _providerBaseUrlBdKwtJTo.u)((0, _providerBaseUrlBdKwtJTo.t)(explicit) ?? "http://127.0.0.1:11434");
  ...
  const configuredBaseUrl = (0, _providerBaseUrlBdKwtJTo.t)(explicit);
