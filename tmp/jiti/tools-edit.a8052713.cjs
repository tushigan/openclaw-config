"use strict";Object.defineProperty(exports, "__esModule", { value: true });exports.createEditTool = createEditTool;exports.createEditToolDefinition = createEditToolDefinition;var _piTui = require("@mariozechner/pi-tui");
var _fs = require("fs");
...
function buildEditCallComponent(component, args, theme) {
  ...
  component.clear();
  component.addChild(new _piTui.Text(formatEditCall(args, theme), 0, 0));
  if (!component.preview) {
    return component;
  }
  const body = "error" in component.preview ? theme.fg("error", component.preview.error) : (0, _diff.renderDiff)(component.preview.diff);
