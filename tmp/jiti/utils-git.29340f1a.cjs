"use strict";Object.defineProperty(exports, "__esModule", { value: true });exports.parseGitUrl = parseGitUrl;var _hostedGitInfo = _interopRequireDefault(require("hosted-git-info"));function _interopRequireDefault(e) {return e && e.__esModule ? e : { default: e };}
...
function parseGenericGitUrl(url) {
  ...
  if (repoWithoutRef.startsWith("https://") ||
...
function parseGitUrl(source) {
  ...
  for (const candidate of hostedCandidates) {
    const info = _hostedGitInfo.default.fromUrl(candidate);
    if (info) {
