...
class TreeSelectorComponent extends _piTui.Container {
  ...
  constructor(tree, currentLeafId, terminalHeight, onSelect, onCancel, onLabelChange, initialSelectedId, initialFilterMode) {
    ...
    const filterKeys = [
    (0, _keybindingHints.keyText)("app.tree.filter.default"),
    (0, _keybindingHints.keyText)("app.tree.filter.noTools"),
    (0, _keybindingHints.keyText)("app.tree.filter.userOnly"),
    (0, _keybindingHints.keyText)("app.tree.filter.labeledOnly"),
    (0, _keybindingHints.keyText)("app.tree.filter.all")].
    join("/");
    const cycleKeys = `${(0, _keybindingHints.keyText)("app.tree.filter.cycleForward")}/${(0, _keybindingHints.keyText)("app.tree.filter.cycleBackward")}`;
    this.addChild(new _piTui.TruncatedText(_theme.theme.fg("muted", `  ↑/↓: move. ←/→: page. ^←/^→ or Alt+←/Alt+→: fold/branch. ${(0, _keybindingHints.keyText)("app.tree.editLabel")}: label. ${filterKeys}: filters (${cycleKeys} cycle). ${(0, _keybindingHints.keyText)("app.tree.toggleLabelTimestamp")}: label time`), 0, 0));
...
}exports.TreeSelectorComponent = TreeSelectorComponent; /* v9-b5cbdf964de28aee */
