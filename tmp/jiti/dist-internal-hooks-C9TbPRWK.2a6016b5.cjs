...
const handlers = (0, _globalSingletonDZyLAEQq.n)(Symbol.for("openclaw.internalHookHandlers"), () => /* @__PURE__ */new Map());
const internalHooksEnabledState = (0, _globalSingletonDZyLAEQq.n)(Symbol.for("openclaw.internalHooksEnabled"), () => ({ enabled: true }));
const log = (0, _subsystemCxWoQXRD.t)("internal-hooks");
/**
