"use strict";Object.defineProperty(exports, "__esModule", { value: true });exports.i = normalizeInboundPathRoots;exports.n = isValidInboundPathRootPattern;exports.r = mergeInboundPathRoots;exports.t = isInboundPathAllowed;var _nodePath = _interopRequireDefault(require("node:path"));function _interopRequireDefault(e) {return e && e.__esModule ? e : { default: e };}
...
function normalizePosixAbsolutePath(value) {
  ...
  const normalized = _nodePath.default.posix.normalize(trimmed.replaceAll("\\", "/"));
