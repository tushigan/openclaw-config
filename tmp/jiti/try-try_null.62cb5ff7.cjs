"use strict";Object.defineProperty(exports, "__esModule", { value: true });exports.TryNull = TryNull;
...
function FromBigInt(value) {
  return _index.Guard.IsEqual(value, BigInt(0)) ? (0, _try_result.Ok)(null) : (0, _try_result.Fail)();
}
// ------------------------------------------------------------------
// Boolean
// ------------------------------------------------------------------
function FromBoolean(value) {
  return _index.Guard.IsEqual(value, false) ? (0, _try_result.Ok)(null) : (0, _try_result.Fail)();
}
// ------------------------------------------------------------------
// Number
// ------------------------------------------------------------------
function FromNumber(value) {
  return _index.Guard.IsEqual(value, 0) ? (0, _try_result.Ok)(null) : (0, _try_result.Fail)();
}
// ------------------------------------------------------------------
// String
// ------------------------------------------------------------------
function FromString(value) {
  ...
  return predicate ? (0, _try_result.Ok)(null) : (0, _try_result.Fail)();
}
// ------------------------------------------------------------------
// Try
// ------------------------------------------------------------------
function TryNull(value) {
  ...
  _index.Guard.IsUndefined(value) ? (0, _try_result.Ok)(null) :
  (0, _try_result.Fail)();
} /* v9-66494a0b34aa18dc */
