"use strict";Object.defineProperty(exports, "__esModule", { value: true });exports.n = resolveWebSearchInstallCatalogEntry;exports.t = resolveWebSearchInstallCatalogEntries;var _utilsD5swhEXt = require("./utils-D5swhEXt.js");
var _officialExternalPluginCatalog64MlR6o = require("./official-external-plugin-catalog--64MlR6o.js");
var _enableBLCgq3fU = require("./enable-BLCgq3fU.js");
...
function setConfigPath(target, path, value) {
  ...
  for (const segment of segments.slice(0, -1)) {
    ...
    if (!(0, _utilsD5swhEXt.c)(next)) current[segment] = {};
    current = current[segment];
  }
...
function buildProviderEntry(params) {
  ...
  return {
    ...
    applySelectionConfig: (config) => (0, _enableBLCgq3fU.t)(config, params.pluginId).config,
    createTool: () => null
  };
}
function resolveWebSearchInstallCatalogEntries() {
  const entries = [];
  for (const entry of (0, _officialExternalPluginCatalog64MlR6o.a)()) {
    const manifest = (0, _officialExternalPluginCatalog64MlR6o.r)(entry);
    const pluginId = normalizeString(manifest?.plugin?.id);
    const install = (0, _officialExternalPluginCatalog64MlR6o.c)(entry);
    ...
    for (const provider of manifest.webSearchProviders ?? []) {
      ...
      entries.push({
        pluginId,
        label: (0, _officialExternalPluginCatalog64MlR6o.l)(entry),
        install,
