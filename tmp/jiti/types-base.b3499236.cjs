"use strict";Object.defineProperty(exports, "__esModule", { value: true });exports.Base = void 0;exports.IsBase = IsBase;
...
function BaseProperty(value) {
  return {
    enumerable: _index.Settings.Get().enumerableKind,
    writable: false,
    configurable: false,
    value
  };
...
// Guard
// ------------------------------------------------------------------
/** Returns true if the given value is a Base type. */exports.Base = Base;
function IsBase(value) {
  return (0, _schema.IsKind)(value, 'Base');
} /* v9-7c7dab039eb9bca4 */
