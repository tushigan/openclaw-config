"use strict";Object.defineProperty(exports, "__esModule", { value: true });exports.i = resolveImageSanitizationLimits;exports.n = sanitizeImageBlocks;exports.r = sanitizeToolResultImages;exports.t = sanitizeContentBlocksImages;var _subsystemCxWoQXRD = require("./subsystem-CxWoQXRD.js");
var _base64CAEN0cuN = require("./base64-CAEN0cuN.js");
var _imageOpsCofkDchS = require("./image-ops-CofkDchS.js");
...
const log = (0, _subsystemCxWoQXRD.t)("agents/tool-images");
...
async function resizeImageBase64IfNeeded(params) {
  ...
  const meta = await (0, _imageOpsCofkDchS.a)(buf);
  ...
  const sideGrid = (0, _imageOpsCofkDchS.r)(params.maxDimensionPx, sideStart);
  let smallest = null;
  for (const side of sideGrid) for (const quality of _imageOpsCofkDchS.t) {
    const out = await (0, _imageOpsCofkDchS.l)({
      buffer: buf,
      maxSide: side,
      quality,
...
async function sanitizeContentBlocksImages(blocks, label, opts = {}) {
  ...
  for (const block of blocks) {
    ...
    const canonicalData = (0, _base64CAEN0cuN.t)(data);
    if (!canonicalData) {
      out.push({
        type: "text",
