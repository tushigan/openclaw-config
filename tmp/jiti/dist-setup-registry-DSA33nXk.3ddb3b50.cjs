...
const CURRENT_MODULE_PATH = (0, _nodeUrl.fileURLToPath)("file:///opt/homebrew/lib/node_modules/openclaw/dist/setup-registry-DSA33nXk.js");
...
function getModuleLoader(modulePath) {
  return (0, _pluginModuleLoaderCacheB600Kx.n)({
    cache: moduleLoaders,
    modulePath,
    importerUrl: "file:///opt/homebrew/lib/node_modules/openclaw/dist/setup-registry-DSA33nXk.js"
  });
}
