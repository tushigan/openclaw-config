"use strict";Object.defineProperty(exports, "__esModule", { value: true });exports.a = isSandboxHostPathAbsolute;exports.c = splitSandboxBindSpec;exports.i = getSandboxHostPathPolicyKey;exports.n = isDangerousNetworkMode;exports.o = normalizeSandboxHostPath;exports.r = normalizeNetworkMode;exports.s = resolveSandboxHostPathViaExistingAncestor;exports.t = getBlockedNetworkModeReason;var _stringCoerceBje8XVt = require("./string-coerce-Bje8XVt9.js");
...
function resolveSandboxHostPathViaExistingAncestor(sourcePath) {
  ...
  return normalizeSandboxHostPath((0, _boundaryPathDbcMiy8Y.i)(sourcePath));
}
//#endregion
//#region src/agents/sandbox/network-mode.ts
function normalizeNetworkMode(network) {
  return (0, _stringCoerceBje8XVt.s)(network) || void 0;
}
