"use strict";Object.defineProperty(exports, "__esModule", { value: true });exports.applyExifOrientation = applyExifOrientation;function readOrientationFromTiff(bytes, tiffStart) {
