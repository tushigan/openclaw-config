"use strict";Object.defineProperty(exports, "__esModule", { value: true });exports.n = resolveGlobalDedupeCache;exports.t = createDedupeCache;var _globalSingletonDZyLAEQq = require("./global-singleton-DZyLAEQq.js");
var _mapSizeDVcVB0gJ = require("./map-size-DVcVB0gJ.js");
...
function createDedupeCache(options) {
  ...
  const prune = (now) => {
    ...
    (0, _mapSizeDVcVB0gJ.t)(cache, maxSize);
  };
...
function resolveGlobalDedupeCache(key, options) {
  return (0, _globalSingletonDZyLAEQq.n)(key, () => createDedupeCache(options));
}
//#endregion /* v9-6e9e99ca314c1303 */
