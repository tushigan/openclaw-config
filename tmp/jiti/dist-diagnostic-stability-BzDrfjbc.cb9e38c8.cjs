"use strict";Object.defineProperty(exports, "__esModule", { value: true });exports.a = selectDiagnosticStabilitySnapshot;exports.i = resetDiagnosticStabilityRecorderForTest;exports.n = getDiagnosticStabilitySnapshot;exports.o = startDiagnosticStabilityRecorder;exports.r = normalizeDiagnosticStabilityQuery;exports.s = stopDiagnosticStabilityRecorder;exports.t = void 0;var _diagnosticEventsCjwOnQj = require("./diagnostic-events-CjwOn-Qj.js");
...
const MAX_DIAGNOSTIC_STABILITY_LIMIT = exports.t = DEFAULT_DIAGNOSTIC_STABILITY_CAPACITY;
...
function sanitizeDiagnosticEvent(event) {
  ...
  switch (event.type) {
    ...
    case "diagnostic.liveness.warning":
      ...
      if (event.activeWorkLabels?.length) record.source = event.activeWorkLabels[0];else
      if (event.queuedWorkLabels?.length) record.source = event.queuedWorkLabels[0];
      break;
...
function summarizeRecords(records) {
  ...
  for (const record of records) {
    ...
    if (record.type === "payload.large") {
      ...
      if (record.action === "rejected") payloadLarge.rejected += 1;else
      if (record.action === "truncated") payloadLarge.truncated += 1;else
      if (record.action === "chunked") payloadLarge.chunked += 1;
...
function startDiagnosticStabilityRecorder() {
  ...
  state.unsubscribe = (0, _diagnosticEventsCjwOnQj.a)((event) => {
