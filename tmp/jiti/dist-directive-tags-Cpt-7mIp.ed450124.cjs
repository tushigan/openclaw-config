"use strict";Object.defineProperty(exports, "__esModule", { value: true });exports.a = stripInlineDirectiveTagsFromMessageForDisplay;exports.i = stripInlineDirectiveTagsForDisplay;exports.n = sanitizeReplyDirectiveId;exports.r = stripInlineDirectiveTagsForDelivery;exports.t = parseInlineDirectives;var _stringCoerceBje8XVt = require("./string-coerce-Bje8XVt9.js");
...
function parseInlineDirectives(text, options = {}) {
  ...
  const replyToId = lastExplicitId ?? (sawCurrent ? (0, _stringCoerceBje8XVt.c)(currentMessageId) : void 0);
  return {
    text: cleaned,
    audioAsVoice,
    replyToId,
