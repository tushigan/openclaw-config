"use strict";Object.defineProperty(exports, "__esModule", { value: true });exports.C = buildNativeAnthropicReplayPolicyForModel;exports.D = resolveTaggedReasoningOutputMode;exports.E = buildStrictAnthropicReplayPolicy;exports.O = sanitizeGoogleGeminiReplayHistory;exports.S = buildHybridAnthropicOrOpenAIReplayPolicy;exports.T = buildPassthroughGeminiSanitizingReplayPolicy;exports._ = normalizeAntigravityPreviewModelId;exports.a = buildProviderReplayFamilyHooks;exports.b = buildAnthropicReplayPolicyForModel;exports.c = isClaudeOpus47ModelId;exports.d = cloneFirstTemplateModel;exports.f = matchesExactOrPrefix;exports.g = streamWithPayloadPatch;exports.h = resolveMoonshotThinkingType;exports.i = void 0;exports.k = shouldPreserveThinkingBlocks;exports.l = isProxyReasoningUnsupportedModelHint;exports.m = resolveMoonshotThinkingKeep;exports.n = void 0;exports.o = getModelProviderHint;exports.p = createMoonshotThinkingWrapper;exports.r = void 0;exports.s = isClaudeAdaptiveThinkingDefaultModelId;exports.t = void 0;exports.u = resolveClaudeThinkingProfile;exports.v = normalizeGooglePreviewModelId;exports.w = buildOpenAICompatibleReplayPolicy;exports.x = buildGoogleGeminiReplayPolicy;exports.y = normalizeNativeXaiModelId;var _stringCoerceBje8XVt = require("./string-coerce-Bje8XVt9.js");
var _lazyPromiseAiZRy56y = require("./lazy-promise-AiZRy56y.js");
require("./gpt5-prompt-overlay-Bn1l8coq.js");
require("./provider-attribution-DaSNL9Cf.js");
var _providerModelCompatCVyieb3F = require("./provider-model-compat-CVyieb3F.js");
var _googleModelsDZIkbiOu = require("./google-models-DZIkbiOu.js");function _interopRequireWildcard(e, t) {if ("function" == typeof WeakMap) var r = new WeakMap(),n = new WeakMap();return (_interopRequireWildcard = function (e, t) {if (!t && e && e.__esModule) return e;var o,i,f = { __proto__: null, default: e };if (null === e || "object" != typeof e && "function" != typeof e) return f;if (o = t ? n : r) {if (o.has(e)) return o.get(e);o.set(e, f);}for (const t in e) "default" !== t && {}.hasOwnProperty.call(e, t) && ((i = (o = Object.defineProperty) && Object.getOwnPropertyDescriptor(e, t)) && (i.get || i.set) ? o(f, t, i) : f[t] = e[t]);return f;})(e, t);}
...
function buildOpenAICompatibleReplayPolicy(modelApi, options = {}) {
  ...
  return {
    ...
    ...(modelApi === "openai-completions" && (0, _googleModelsDZIkbiOu.t)(options.modelId) ? { dropReasoningFromHistory: true } : {})
  };
}
...
function shouldPreserveThinkingBlocks(modelId) {
  const id = (0, _stringCoerceBje8XVt.a)(modelId);
...
function buildAnthropicReplayPolicyForModel(modelId) {
  return buildStrictAnthropicReplayPolicy({ dropThinkingBlocks: (0, _stringCoerceBje8XVt.a)(modelId).includes("claude") && !shouldPreserveThinkingBlocks(modelId) });
}
function buildNativeAnthropicReplayPolicyForModel(modelId) {
  return buildStrictAnthropicReplayPolicy({
    dropThinkingBlocks: (0, _stringCoerceBje8XVt.a)(modelId).includes("claude") && !shouldPreserveThinkingBlocks(modelId),
    sanitizeToolCallIds: true,
...
function buildHybridAnthropicOrOpenAIReplayPolicy(ctx, options = {}) {
  if (ctx.modelApi === "anthropic-messages" || ctx.modelApi === "bedrock-converse-stream") {
    const isClaude = (0, _stringCoerceBje8XVt.a)(ctx.modelId).includes("claude");
...
function buildPassthroughGeminiSanitizingReplayPolicy(modelId) {
  return {
    ...
    validateGeminiTurns: false,
    validateAnthropicTurns: false,
    ...((0, _stringCoerceBje8XVt.a)(modelId).includes("gemini") ? { sanitizeThoughtSignatures: {
        allowBase64Only: true,
        includeCamelCase: true
      } } : {})
  };
...
function sanitizeGoogleGeminiReplayHistory(ctx) {
  const messages = (0, _googleModelsDZIkbiOu.n)(ctx.messages);
...
const piAiRuntimeLoader = (0, _lazyPromiseAiZRy56y.t)(() => Promise.resolve().then(() => jitiImport("@mariozechner/pi-ai").then((m) => _interopRequireWildcard(m))));
...
function normalizeMoonshotThinkingKeep(value) {
  ...
  return (0, _stringCoerceBje8XVt.s)(keepValue) === "all" ? "all" : void 0;
}
...
function matchesExactOrPrefix(id, values) {
  const normalizedId = (0, _stringCoerceBje8XVt.a)(id);
  return values.some((value) => {
    const normalizedValue = (0, _stringCoerceBje8XVt.a)(value);
...
function cloneFirstTemplateModel(params) {
  ...
  for (const templateId of [...new Set(params.templateIds)].filter(Boolean)) {
    ...
    return (0, _providerModelCompatCVyieb3F.a)({
      ...template,
      id: trimmedModelId,
      name: trimmedModelId,
      ...params.patch
...
function getModelProviderHint(modelId) {
  const trimmed = (0, _stringCoerceBje8XVt.s)(modelId);
...
function matchesClaudeModelPrefix(modelId, prefixes) {
  const lower = (0, _stringCoerceBje8XVt.s)(modelId);
