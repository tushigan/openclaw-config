 ...
 */
class WarningSettingsSubmenu extends _piTui.Container {
  settingsList;
  state;
  constructor(warnings, onChange, onCancel) {
    ...
    this.settingsList = new _piTui.SettingsList(items, Math.min(items.length, 10), (0, _theme.getSettingsListTheme)(), (id, newValue) => {
      switch (id) {
...
}exports.SettingsSelectorComponent = SettingsSelectorComponent; /* v9-00694df399651f3b */
