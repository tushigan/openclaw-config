"use strict";Object.defineProperty(exports, "__esModule", { value: true });exports.ro_RO = ro_RO; // deno-fmt-ignore-file
// deno-coverage-ignore-start
/** Romanian (Romania) - ISO 639-1 language code 'ro' with ISO 3166-1 alpha-2 country code 'RO' for Romania. */
function ro_RO(error) {
...
// deno-coverage-ignore-stop /* v9-9a3fd47cdcad4863 */
