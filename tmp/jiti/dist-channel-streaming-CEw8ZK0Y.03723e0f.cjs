"use strict";Object.defineProperty(exports, "__esModule", { value: true });exports.C = resolveChannelStreamingPreviewToolProgress;exports.S = resolveChannelStreamingPreviewCommandText;exports._ = resolveChannelStreamingBlockCoalesce;exports.a = createChannelProgressDraftGate;exports.b = resolveChannelStreamingNativeTransport;exports.c = formatChannelProgressDraftText;exports.d = resolveChannelPreviewStreamMode;exports.f = resolveChannelProgressDraftConfig;exports.g = resolveChannelProgressDraftRender;exports.h = resolveChannelProgressDraftMaxLines;exports.i = buildChannelProgressDraftLineForEntry;exports.l = getChannelStreamingConfigObject;exports.m = resolveChannelProgressDraftLineOptions;exports.n = void 0;exports.o = formatChannelProgressDraftLine;exports.p = resolveChannelProgressDraftLabel;exports.r = buildChannelProgressDraftLine;exports.s = formatChannelProgressDraftLineForEntry;exports.t = void 0;exports.u = isChannelProgressDraftWorkToolName;exports.v = resolveChannelStreamingBlockEnabled;exports.w = resolveChannelStreamingSuppressDefaultToolProgressMessages;exports.x = resolveChannelStreamingPreviewChunk;exports.y = resolveChannelStreamingChunkMode;var _stringCoerceBje8XVt = require("./string-coerce-Bje8XVt9.js");
var _toolDisplayCePrqCCy = require("./tool-display-CePrqCCy.js");
var _toolMetaDko5Q20H = require("./tool-meta-Dko5Q20H.js");
...
function normalizeStreamingMode(value) {
  ...
  return (0, _stringCoerceBje8XVt.s)(value) || null;
}
...
const DEFAULT_PROGRESS_DRAFT_LABELS = exports.n = [
"Thinking...",
"Shelling...",
"Scuttling...",
"Clawing...",
...
const DEFAULT_PROGRESS_DRAFT_INITIAL_DELAY_MS = exports.t = 5e3;
...
function isChannelProgressDraftWorkToolName(name) {
  const normalized = (0, _stringCoerceBje8XVt.s)(name);
...
function inferToolMeta(name, args, detailMode = "explain") {
  if (!name || !args) return;
  return (0, _toolDisplayCePrqCCy.t)((0, _toolDisplayCePrqCCy.r)({
    name,
    args,
    detailMode
  }));
...
function buildNamedProgressLine(kind, name, metas, options, fields) {
  ...
  const text = (0, _toolMetaDko5Q20H.t)(normalizedName, compactMetas.length ? compactMetas : void 0, { markdown: options?.markdown });
  const display = (0, _toolDisplayCePrqCCy.r)({ name: normalizedName });
...
function itemKindToToolName(kind) {
  switch ((0, _stringCoerceBje8XVt.s)(kind)) {
...
function isCommandProgressItem(input) {
  return (0, _stringCoerceBje8XVt.s)(input.itemKind) === "command" || isCommandToolName(input.name);
}
function isEmptyReasoningProgressItem(input, meta) {
  return !meta && (0, _stringCoerceBje8XVt.s)(input.itemKind) === "analysis" && (0, _stringCoerceBje8XVt.s)(input.title) === "reasoning";
}
...
function resolveChannelProgressDraftLabel(params) {
  ...
  const normalizedLabel = typeof progress.label === "string" ? (0, _stringCoerceBje8XVt.s)(progress.label) : null;
