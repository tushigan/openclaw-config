"use strict";Object.defineProperty(exports, "__esModule", { value: true });exports.t = assertNoOAuthSecretRefPolicyViolations;var _typesSecretsCL51SR4g = require("./types.secrets-CL51SR4g.js");
...
function hasSecretRefInput(params) {
  return (0, _typesSecretsCL51SR4g.m)({
    value: params.value,
...
function collectTypeOAuthSecretRefViolations(params) {
  ...
  "keyRef"])
  {
    if ((0, _typesSecretsCL51SR4g.o)(record[field], params.defaults) === null) continue;
