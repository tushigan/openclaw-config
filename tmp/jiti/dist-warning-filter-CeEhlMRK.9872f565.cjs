"use strict";Object.defineProperty(exports, "__esModule", { value: true });exports.n = shouldIgnoreWarning;exports.t = installProcessWarningFilter;var _globalSingletonDZyLAEQq = require("./global-singleton-DZyLAEQq.js");
...
function installProcessWarningFilter() {
  const state = (0, _globalSingletonDZyLAEQq.n)(warningFilterKey, () => ({ installed: false }));
