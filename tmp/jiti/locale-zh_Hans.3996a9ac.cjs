"use strict";Object.defineProperty(exports, "__esModule", { value: true });exports.zh_Hans = zh_Hans; // deno-fmt-ignore-file
// deno-coverage-ignore-start
/** Chinese (Simplified) - ISO 639-1 language code 'zh' with script code 'Hans' for Simplified Chinese. */
function zh_Hans(error) {
...
// deno-coverage-ignore-stop /* v9-4cf343907142caf3 */
