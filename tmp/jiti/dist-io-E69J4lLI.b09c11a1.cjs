"use strict";Object.defineProperty(exports, "__esModule", { value: true });exports.A = applyConfigOverrides;exports.B = isPluginLocalInvalidConfigSnapshot;exports.C = validateConfigObjectRaw;exports.D = collectPluginSchemaMetadata;exports.E = collectChannelSchemaMetadata;exports.F = asResolvedSourceConfig;exports.G = getShellEnvAppliedKeys;exports.H = createInvalidConfigError;exports.I = asRuntimeConfig;exports.J = resolveShellEnvFallbackTimeoutMs;exports.K = getShellPathFromLoginShell;exports.L = resolveNormalizedProviderModelMaxTokens;exports.M = resetConfigOverrides;exports.N = setConfigOverride;exports.O = void 0;exports.P = unsetConfigOverride;exports.R = applyUnsetPathsForWrite;exports.S = validateConfigObject;exports.T = validateConfigObjectWithPlugins;exports.U = formatInvalidConfigDetails;exports.V = shouldAttemptLastKnownGoodRecovery;exports.W = maintainConfigBackups;exports.X = resolveOwnerDisplaySetting;exports.Y = shouldEnableShellEnvFallback;exports._ = recoverConfigFromLastKnownGood;exports.a = loadConfig;exports.b = writeConfigFile;exports.c = promoteConfigSnapshotToLastKnownGood;exports.d = readConfigFileSnapshotForWrite;exports.f = readConfigFileSnapshotWithPluginMetadata;exports.g = recoverConfigFromJsonRootSuffix;exports.h = readSourceConfigSnapshotForWrite;exports.i = getRuntimeConfig;exports.j = getConfigOverrides;exports.k = resolveShellEnvExpectedKeys;exports.l = readBestEffortConfig;exports.m = readSourceConfigSnapshot;exports.n = clearConfigCache;exports.o = parseConfigJson5;exports.p = readSourceConfigBestEffort;exports.q = loadShellEnvFallback;exports.r = createConfigIO;exports.s = projectConfigOntoRuntimeSourceSnapshot;exports.t = void 0;exports.u = readConfigFileSnapshot;exports.v = registerConfigWriteListener;exports.w = validateConfigObjectRawWithPlugins;exports.x = collectUnsupportedSecretRefPolicyIssues;exports.y = resolveConfigSnapshotHash;exports.z = resolveManagedUnsetPathsForWrite;var _redact1fZUZMlV = require("./redact-1fZUZMlV.js");
...
var _envCHKgtsNu = require("./env-CHKgtsNu.js");
...
var _stateDirDotenvBPwOIUAE = require("./state-dir-dotenv-BPwOIUAE.js");
...
var _dotenvYQXomdVq = require("./dotenv-YQXomdVq.js");
var _installedPluginIndexRecordsCVO2sce = require("./installed-plugin-index-records-CVO2sce8.js");
var _safeTextBe5ocph = require("./safe-text-Be-5ocph.js");
var _includesCjiK0ofJ = require("./includes-CjiK0ofJ.js");
var _issueFormatCEIVxsoT = require("./issue-format-CEIVxsoT.js");
var _mergePatchC3PIQ2jH = require("./merge-patch-C3PIQ2jH.js");
var _defaultsCbe87E7A = require("./defaults-Cbe87E7A.js");
var _providerPublicArtifactsBto26nnC = require("./provider-public-artifacts-Bto26nnC.js");
var _talkUmkNj9Rb = require("./talk-umkNj9Rb.js");
var _execSafeBinTrustQSmYcZQS = require("./exec-safe-bin-trust-QSmYcZQS.js");
var _pluginInstallConfigMigrationQDfbwB__ = require("./plugin-install-config-migration-qDfbwB__.js");
var _configPathsEPlrwsFe = require("./config-paths-EPlrwsFe.js");
...
var _catalogDYcB5w_ = require("./catalog-DYcB5w-_.js");
...
var _webSearchInstallCatalogBGLm1UMr = require("./web-search-install-catalog-BGLm1UMr.js");
var _avatarPolicyB3KBNYI = require("./avatar-policy-B3KBNYI7.js");
var _modelRefsDDcinLNL = require("./model-refs-DDcinLNL.js");
var _zodSchemaCOgITMqv = require("./zod-schema-COgITMqv.js");
var _version6ogXOanN = require("./version-6ogXOanN.js");
...
function resolveOwnerDisplaySetting(config) {
  ...
  return {
    ownerDisplay: "hash",
    ownerDisplaySecret: (0, _stringCoerceBje8XVt.c)(config?.commands?.ownerDisplaySecret)
  };
}
/**
...
function resolveShellExecEnv(env) {
  const execEnv = (0, _hostEnvSecurityCXDv4ev.o)({ baseEnv: env });
...
function shouldEnableShellEnvFallback(env) {
  return (0, _envCHKgtsNu.t)(env.OPENCLAW_LOAD_SHELL_ENV);
}
function shouldDeferShellEnvFallback(env) {
  return (0, _envCHKgtsNu.t)(env.OPENCLAW_DEFER_SHELL_ENV_FALLBACK);
}
...
function canonicalizeAgentDir(agentDir) {
  ...
  if (process.platform === "darwin" || process.platform === "win32") return (0, _stringCoerceBje8XVt.a)(resolved);
  return resolved;
}
function collectReferencedAgentIds(cfg) {
  ...
  ids.add((0, _sessionKeyC0K0uhmG.c)(defaultAgentId));
  for (const entry of agents) if (entry?.id) ids.add((0, _sessionKeyC0K0uhmG.c)(entry.id));
  const bindings = cfg.bindings;
  if (Array.isArray(bindings)) for (const binding of bindings) {
    const id = binding?.agentId;
    if (typeof id === "string" && id.trim()) ids.add((0, _sessionKeyC0K0uhmG.c)(id));
  }
  return [...ids];
}
function resolveEffectiveAgentDir(cfg, agentId, deps) {
  const id = (0, _sessionKeyC0K0uhmG.c)(agentId);
  const trimmed = (Array.isArray(cfg.agents?.list) ? cfg.agents?.list.find((agent) => (0, _sessionKeyC0K0uhmG.c)(agent.id) === id)?.agentDir : void 0)?.trim();
  if (trimmed) return (0, _utilsD5swhEXt.p)(trimmed);
  const env = deps?.env ?? process.env;
  const root = (0, _pathsC1_Y0cDn.v)(env, deps?.homedir ?? (() => (0, _homeDirG5LU3LmA.o)(env, _nodeOs.default.homedir)));
...
function restoreEnvVarRefs(incoming, parsed, env = process.env) {
  ...
  if ((0, _utilsD5swhEXt.x)(incoming) && (0, _utilsD5swhEXt.x)(parsed)) {
    const result = {};
...
function redactConfigAuditArgv(argv) {
  ...
  for (let i = 0; i < argv.length; i++) {
    ...
    result.push((0, _redact1fZUZMlV.o)(current));
  }
  return result;
}
...
function resolveConfigAuditLogPath(env, homedir) {
  return _nodePath.default.join((0, _pathsC1_Y0cDn.v)(env, homedir), "logs", CONFIG_AUDIT_LOG_FILENAME);
}
...
function formatInvalidConfigDetails(issues) {
  return issues.map((issue) => `- ${(0, _safeTextBe5ocph.t)(issue.path || "<root>")}: ${(0, _safeTextBe5ocph.t)(issue.message)}`).join("\n");
}
...
function hasConfigMeta$1(value) {
  return (0, _utilsD5swhEXt.c)(value) && (0, _utilsD5swhEXt.c)(value.meta) && (typeof value.meta.lastTouchedVersion === "string" || typeof value.meta.lastTouchedAt === "string");
}
function resolveGatewayMode$1(value) {
  if (!(0, _utilsD5swhEXt.c)(value) || !(0, _utilsD5swhEXt.c)(value.gateway)) return null;
...
function resolveConfigHealthStatePath$1(env, homedir) {
  return _nodePath.default.join((0, _pathsC1_Y0cDn.v)(env, homedir), "logs", "config-health.json");
}
...
async function readConfigHealthState$1(deps) {
  try {
    ...
    return (0, _utilsD5swhEXt.c)(parsed) ? parsed : {};
  } catch {
    return {};
  }
}
...
function getConfigHealthEntry$1(state, configPath) {
  ...
  if (!entries || !(0, _utilsD5swhEXt.c)(entries)) return {};
  const entry = entries[configPath];
  return entry && (0, _utilsD5swhEXt.c)(entry) ? entry : {};
}
...
function collectPollutedSecretPlaceholders(value, pathLabel = "", output = []) {
  ...
  if ((0, _utilsD5swhEXt.c)(value)) for (const [key, child] of Object.entries(value)) collectPollutedSecretPlaceholders(child, pathLabel ? `${pathLabel}.${key}` : key, output);
  return output;
}
...
async function recoverConfigFromLastKnownGood$1(params) {
  ...
  const issueSummary = (0, _issueFormatCEIVxsoT.r)([...snapshot.issues, ...snapshot.legacyIssues]);
...
function createMergePatch(base, target) {
  if (!(0, _utilsD5swhEXt.c)(base) || !(0, _utilsD5swhEXt.c)(target)) return cloneUnknown(target);
  const patch = {};
  ...
  for (const key of keys) {
    ...
    if ((0, _utilsD5swhEXt.c)(baseValue) && (0, _utilsD5swhEXt.c)(targetValue)) {
      const childPatch = createMergePatch(baseValue, targetValue);
      if ((0, _utilsD5swhEXt.c)(childPatch) && Object.keys(childPatch).length === 0) continue;
...
function projectSourceOntoRuntimeShape(source, runtime) {
  if (!(0, _utilsD5swhEXt.c)(source) || !(0, _utilsD5swhEXt.c)(runtime)) return cloneUnknown(source);
  const next = {};
...
function hasOwnIncludeKey(value) {
  return (0, _utilsD5swhEXt.c)(value) && Object.prototype.hasOwnProperty.call(value, "$include");
}
...
function patchTouchesPath(patch, path) {
  if (path.length === 0) return (0, _utilsD5swhEXt.c)(patch) ? Object.keys(patch).length > 0 : true;
  if (!(0, _utilsD5swhEXt.c)(patch)) return true;
...
function getPathValue(value, path) {
  ...
  for (const segment of path) {
    if (!(0, _utilsD5swhEXt.c)(current)) return;
...
function setPathValue(value, path, nextValue) {
  ...
  if (!(0, _utilsD5swhEXt.c)(value)) return value;
  const [head, ...tail] = path;
  return {
    ...value,
...
function setPathValueCreatingParents(value, path, nextValue) {
  if (path.length === 0) return cloneUnknown(nextValue);
  const [head, ...tail] = path;
  const record = (0, _utilsD5swhEXt.c)(value) ? value : {};
  return {
    ...record,
...
function preserveAuthoredAgentParams(params) {
  ...
  if (!(0, _utilsD5swhEXt.c)(defaults)) return params.persistedCandidate;
  ...
  if (!(0, _utilsD5swhEXt.c)(models)) return next;
  for (const [modelId, modelEntry] of Object.entries(models)) {
    if (!(0, _utilsD5swhEXt.c)(modelEntry) || !Object.prototype.hasOwnProperty.call(modelEntry, "params")) continue;
    const modelPath = [
    "agents",
    "defaults",
    "models",
...
function resolvePersistCandidateForWrite(params) {
  ...
  const persisted = preserveUntouchedIncludes({
    patch,
    rootAuthoredConfig,
    persistedCandidate: (0, _mergePatchC3PIQ2jH.t)(projectedSource, patch)
  });
...
function readRootSchemaUri(value) {
  if (!(0, _utilsD5swhEXt.c)(value) || typeof value.$schema !== "string") return;
  return value.$schema;
}
function hasOwnRootSchemaKey(value) {
  return (0, _utilsD5swhEXt.c)(value) && Object.prototype.hasOwnProperty.call(value, "$schema");
}
function preserveRootSchemaUri(params) {
  ...
  if (sourceSchema === void 0 || !(0, _utilsD5swhEXt.c)(params.persistedCandidate)) return params.persistedCandidate;
  return {
...
function unsetPathForWriteAt(value, pathSegments, depth) {
  ...
  if ((0, _prototypeKeysBWjW0VW.t)(segment) || !isWritePlainObject(value) || !hasOwnObjectKey(value, segment)) return {
    changed: false,
    value
  };
  if (isLeaf) {
...
function collectChangedPaths(base, target, path, output) {
  ...
  if ((0, _utilsD5swhEXt.c)(base) && (0, _utilsD5swhEXt.c)(target)) {
    const keys = new Set([...Object.keys(base), ...Object.keys(target)]);
    for (const key of keys) {
...
function normalizeProviderConfigForConfigDefaults(params) {
  const normalized = (0, _providerPublicArtifactsBto26nnC.t)(params.provider, { manifestRegistry: params.manifestRegistry })?.normalizeConfig?.({
...
function applyProviderConfigDefaultsForConfig(params) {
  return (0, _providerPublicArtifactsBto26nnC.t)(params.provider, { manifestRegistry: params.manifestRegistry })?.applyConfigDefaults?.({
    provider: params.provider,
...
function resolveNormalizedProviderModelMaxTokens(params) {
  ...
  if ((0, _providerIdDIRgKpoh.r)(params.providerId) !== "mistral" || clamped < params.contextWindow) return clamped;
...
function applyTalkConfigNormalization(config) {
  return (0, _talkUmkNj9Rb.n)(config);
}
  ...
  if (providerConfig) {
    ...
    for (const [providerId, provider] of Object.entries(providerConfig)) {
      ...
      const nextModels = models.map((model) => {
        ...
        const contextWindow = isPositiveNumber(raw.contextWindow) ? raw.contextWindow : _defaultsCbe87E7A.t;
...
function hasAnthropicDefaultSignal(cfg, env) {
  ...
  if (profiles) for (const profile of Object.values(profiles)) {
    const provider = (0, _providerIdDIRgKpoh.r)(profile?.provider);
    if (provider === "anthropic" || provider === "claude-cli") return true;
  }
  const order = cfg.auth?.order;
  if (!order) return false;
  return Object.keys(order).some((provider) => {
    const normalizedProvider = (0, _providerIdDIRgKpoh.r)(provider);
...
function normalizeExecSafeBinProfilesInConfig(cfg) {
  const normalizeExec = (exec) => {
    ...
    const normalizedProfiles = (0, _execSafeBinTrustQSmYcZQS.K)(typedExec.safeBinProfiles);
    typedExec.safeBinProfiles = Object.keys(normalizedProfiles).length > 0 ? normalizedProfiles : void 0;
    const normalizedTrustedDirs = (0, _execSafeBinTrustQSmYcZQS.i)(typedExec.safeBinTrustedDirs);
...
function normalizeStringValue(key, value) {
  ...
  if (!key) return value;
  if (PATH_KEY_RE.test(key) || PATH_LIST_KEYS.has(key)) return (0, _utilsD5swhEXt.p)(value);
  return value;
}
function normalizeAny(key, value) {
  ...
  if (Array.isArray(value)) {
    ...
    return value.map((entry) => {
      ...
      if ((0, _utilsD5swhEXt.x)(entry)) return normalizeAny(void 0, entry);
      return entry;
    });
  }
  if (!(0, _utilsD5swhEXt.x)(value)) return value;
...
function sanitizeOverrideValue(value, seen = /* @__PURE__ */new WeakSet()) {
  ...
  for (const [key, entry] of Object.entries(value)) {
    if (entry === void 0 || (0, _prototypeKeysBWjW0VW.t)(key)) continue;
...
function mergeOverrides(base, override) {
  if (!(0, _utilsD5swhEXt.x)(base) || !(0, _utilsD5swhEXt.x)(override)) return override;
  const next = { ...base };
  for (const [key, value] of Object.entries(override)) {
    if (value === void 0 || (0, _prototypeKeysBWjW0VW.t)(key)) continue;
...
function setConfigOverride(pathRaw, value) {
  const parsed = (0, _configPathsEPlrwsFe.n)(pathRaw);
  if (!parsed.ok || !parsed.path) return {
    ok: false,
    error: parsed.error ?? "Invalid path."
  };
  (0, _configPathsEPlrwsFe.r)(overrides, parsed.path, sanitizeOverrideValue(value));
  return { ok: true };
}
function unsetConfigOverride(pathRaw) {
  ...
  return {
    ok: true,
    removed: (0, _configPathsEPlrwsFe.i)(overrides, parsed.path)
  };
}
...
function resolveShellEnvExpectedKeys(env) {
  return [...new Set([
  ...(0, _providerEnvVarsPk6C_sd.n)({ env }),
  ...(0, _channelEnvVarsD7WdYxF.n)({ env }),
  ...CORE_SHELL_ENV_EXPECTED_KEYS]
  )];
}
//#endregion
//#region src/config/bundled-channel-config-metadata.generated.ts
const GENERATED_BUNDLED_CHANNEL_CONFIG_METADATA = exports.O = [
{
...
function collectPatternCandidates(params) {
  ...
  if (token.kind === "wildcard") {
    ...
    if (!(0, _utilsD5swhEXt.c)(params.current)) return;
...
function stripDeprecatedValidationKeys(raw) {
  if (!(0, _utilsD5swhEXt.c)(raw) || !(0, _utilsD5swhEXt.c)(raw.commands) || !Object.hasOwn(raw.commands, "modelsWrite")) return raw;
...
function formatMissingOfficialExternalPluginWarning(pluginId) {
  const catalogEntry = (0, _officialExternalPluginCatalog64MlR6o.t)(pluginId);
  if (!catalogEntry) return null;
  const install = (0, _officialExternalPluginCatalog64MlR6o.c)(catalogEntry);
...
function collectRawBundledChannelConfigIssues(config) {
  if (!config.channels || !(0, _utilsD5swhEXt.c)(config.channels)) return [];
  const issues = [];
...
function mapZodIssueToConfigIssue(issue) {
  ...
  const allowedValuesSummary = (0, _schemaValidatorDSVrkbYC.r)(collectAllowedValuesFromUnknownIssue(issue));
  ...
  return {
    path,
    message: (0, _schemaValidatorDSVrkbYC.n)(message, allowedValuesSummary),
...
function isWorkspaceAvatarPath(value, workspaceDir) {
  ...
  return (0, _avatarPolicyB3KBNYI.o)(workspaceRoot, _nodePath.default.resolve(workspaceRoot, value));
}
function validateIdentityAvatar(config) {
  ...
  for (const [index, entry] of agents.entries()) {
    ...
    if (!avatar) continue;
    if ((0, _avatarPolicyB3KBNYI.r)(avatar) || (0, _avatarPolicyB3KBNYI.i)(avatar)) continue;
    ...
    if ((0, _avatarPolicyB3KBNYI.n)(avatar) && !(0, _avatarPolicyB3KBNYI.c)(avatar)) {
      issues.push({
        path: `agents.list.${index}.identity.avatar`,
        message: "identity.avatar must be a workspace-relative path, http(s) URL, or data URI."
      });
    ...
    if (!isWorkspaceAvatarPath(avatar, (0, _agentScopeB6RIBoEj.x)(config, entry.id ?? (0, _agentScopeB6RIBoEj.S)(config)))) issues.push({
      path: `agents.list.${index}.identity.avatar`,
...
function validateGatewayTailscaleBind(config) {
  ...
  if (bindMode === "custom" && (0, _ip9c4ODEZi.i)(customBindHost) && (0, _ip9c4ODEZi.u)(customBindHost)) return [];
  return [{
    path: "gateway.bind",
...
function validateConfigObjectRaw(raw, opts) {
  ...
  const validated = _zodSchemaCOgITMqv.t.safeParse(normalizedRaw);
...
function validateConfigObjectWithPluginsBase(raw, opts) {
  ...
  const issues = [];
  const warnings = [];
  const hasExplicitPluginsConfig = (0, _utilsD5swhEXt.c)(raw) && Object.prototype.hasOwnProperty.call(raw, "plugins");
  ...
  const loadValidationRegistry = () => {
    ...
    registryInfo = { registry: (0, _pluginMetadataSnapshotMEvRUosy.r)({
        config,
        workspaceDir: (0, _agentScopeB6RIBoEj.x)(config, (0, _agentScopeB6RIBoEj.S)(config)) ?? void 0,
  ...
  const ensureCompatConfig = () => {
    ...
    compatConfig = (0, _bundledCompatBCabKG5D.t)({
      config,
  ...
  const ensureNormalizedPlugins = () => {
    const info = ensureRegistry();
    if (!info.normalizedPlugins) info.normalizedPlugins = (0, _configStateWKtsQXM.s)(ensureCompatConfig().plugins);
  ...
  const ensureInstalledPluginRecordIds = () => {
    ...
    try {
      installedPluginRecordIds = new Set(Object.keys((0, _manifestRegistryBiAsJcRZ.s)({ env: opts.env })).map(_configStateWKtsQXM.o));
    } catch {
  ...
  const hasStalePluginEvidenceForUnknownChannel = (channelId) => {
    const normalizedChannelId = (0, _configStateWKtsQXM.o)(channelId);
    if (!normalizedChannelId || ensureKnownIds().has(normalizedChannelId)) return false;
    const pluginConfig = config.plugins;
    if (Array.isArray(pluginConfig?.allow) && pluginConfig.allow.some((pluginId) => (0, _configStateWKtsQXM.o)(pluginId) === normalizedChannelId)) return true;
    if ((0, _utilsD5swhEXt.c)(pluginConfig?.entries) && Object.keys(pluginConfig.entries).some((pluginId) => (0, _configStateWKtsQXM.o)(pluginId) === normalizedChannelId)) return true;
    if ((0, _utilsD5swhEXt.c)(pluginConfig?.installs) && Object.keys(pluginConfig.installs).some((pluginId) => (0, _configStateWKtsQXM.o)(pluginId) === normalizedChannelId)) return true;
  ...
  const findInstallableChannelCatalogEntry = (channelId) => {
    const normalizedChannelId = (0, _stringCoerceBje8XVt.a)(channelId);
    if (!normalizedChannelId) return;
    return (0, _catalogDYcB5w_.r)({
      env: opts.env,
      excludeWorkspace: true
    }).find((entry) => (0, _stringCoerceBje8XVt.a)(entry.id) === normalizedChannelId);
  };
  const collectKnownWebSearchProviderIds = () => {
    return [...new Set([...collectActiveWebSearchProviderIds(), ...(0, _webSearchInstallCatalogBGLm1UMr.t)().map((entry) => entry.provider.id.trim()).filter((providerId) => providerId.length > 0)])].toSorted((left, right) => left.localeCompare(right));
  };
  const hasStalePluginEvidenceForUnknownWebSearchProvider = (providerId) => {
    const normalizedProviderId = (0, _configStateWKtsQXM.o)(providerId);
    if (!normalizedProviderId || ensureKnownIds().has(normalizedProviderId)) return false;
    const pluginConfig = config.plugins;
    if (Array.isArray(pluginConfig?.allow) && pluginConfig.allow.some((pluginId) => (0, _configStateWKtsQXM.o)(pluginId) === normalizedProviderId)) return true;
    if ((0, _utilsD5swhEXt.c)(pluginConfig?.entries) && Object.keys(pluginConfig.entries).some((pluginId) => (0, _configStateWKtsQXM.o)(pluginId) === normalizedProviderId)) return true;
    if ((0, _utilsD5swhEXt.c)(pluginConfig?.installs) && Object.keys(pluginConfig.installs).some((pluginId) => (0, _configStateWKtsQXM.o)(pluginId) === normalizedProviderId)) return true;
  ...
  const validateWebSearchProvider = () => {
    ...
    const installCatalogEntry = (0, _webSearchInstallCatalogBGLm1UMr.t)().find((entry) => entry.provider.id === trimmed);
  ...
  const parseProviderModelRef = (value) => {
    ...
    const provider = (0, _stringCoerceBje8XVt.a)(value.slice(0, slashIndex));
    const model = (0, _stringCoerceBje8XVt.a)(value.slice(slashIndex + 1));
  ...
  const validateConfiguredModelRefs = () => {
    const configuredRefs = (0, _modelRefsDDcinLNL.n)(config);
    if (configuredRefs.length === 0) return;
    const { registry } = ensureRegistry();
    const suppressedModels = /* @__PURE__ */new Map();
    for (const suppression of (0, _discoveryCVL9KJt.O)({ registry }).suppressions) {
  ...
  if (config.channels && (0, _utilsD5swhEXt.c)(config.channels)) for (const key of Object.keys(config.channels)) {
  ...
  for (const channelId of _idsPHiL43bp.t) heartbeatChannelIds.add((0, _stringCoerceBje8XVt.a)(channelId));
  const validateHeartbeatTarget = (target, path) => {
    ...
    if ((0, _idsPHiL43bp.r)(trimmed)) return;
    if (!heartbeatChannelIds.has(normalized)) {
      const { registry } = ensureRegistry();
      for (const record of registry.plugins) for (const channelId of record.channels) {
        const pluginChannel = channelId.trim();
        if (pluginChannel) heartbeatChannelIds.add((0, _stringCoerceBje8XVt.a)(pluginChannel));
      }
    }
  ...
  const normalizeBlockedDiagnosticPath = (value) => {
    ...
    if (!trimmed) return "";
    try {
      return _nodePath.default.resolve((0, _utilsD5swhEXt.p)(trimmed, opts.env ?? process.env));
    } catch {
  ...
  for (const diag of registry.diagnostics) {
    ...
    if (diag.pluginId) {
      const normalizedPluginId = (0, _configStateWKtsQXM.o)(diag.pluginId);
  ...
  const blockedDiagnosticSourceMatchesPluginId = (diagnostic, pluginId) => {
    const normalizedPluginId = (0, _configStateWKtsQXM.o)(pluginId);
    if (!normalizedPluginId) return false;
    const sourcePath = normalizeBlockedDiagnosticPath(diagnostic.source);
    if (!sourcePath) return false;
    if ((0, _configStateWKtsQXM.o)(_nodePath.default.basename(sourcePath)) === normalizedPluginId || (0, _configStateWKtsQXM.o)(_nodePath.default.basename(_nodePath.default.dirname(sourcePath))) === normalizedPluginId) return true;
    ...
    for (const loadPath of loadPaths) {
      ...
      if ((0, _configStateWKtsQXM.o)(_nodePath.default.basename(resolvedLoadPath)) !== normalizedPluginId) continue;
      if (sourcePath === resolvedLoadPath || sourcePath.startsWith(`${resolvedLoadPath}${_nodePath.default.sep}`) || resolvedLoadPath.startsWith(`${sourcePath}${_nodePath.default.sep}`)) return true;
    }
    return false;
  };
  const findBlockedPluginDiagnostic = (pluginId) => {
    const direct = blockedPluginDiagnostics.get(pluginId) ?? blockedPluginDiagnostics.get((0, _configStateWKtsQXM.o)(pluginId));
  ...
  if (entries && (0, _utilsD5swhEXt.c)(entries)) {
  ...
  for (const pluginId of allow) {
    ...
    if (!knownIds.has(pluginId)) {
      const commandAlias = (0, _manifestCommandAliasesDrjTD2KD.n)({
        command: pluginId,
        registry
      });
  ...
  for (const record of registry.plugins) {
    ...
    if (enabled) {
      ...
      if (memoryDecision.selected && (0, _slotsCQkAb1S.r)(record.kind, "memory")) selectedMemoryPluginId = pluginId;
    }
    ...
    if (enabled || entryHasConfig) if (record.configSchema) {
      const res = (0, _schemaValidatorDSVrkbYC.t)({
...
async function tightenStateDirPermissionsIfNeeded(params) {
  ...
  const stateDir = (0, _pathsC1_Y0cDn.v)(params.env, params.homedir);
...
function hasConfigMeta(value) {
  ...
  return (0, _utilsD5swhEXt.c)(meta);
}
function resolveGatewayMode(value) {
  if (!(0, _utilsD5swhEXt.c)(value)) return null;
  const gateway = value.gateway;
  if (!(0, _utilsD5swhEXt.c)(gateway) || typeof gateway.mode !== "string") return null;
  const trimmed = gateway.mode.trim();
  return trimmed.length > 0 ? trimmed : null;
}
function collectEnvRefPaths(value, path, output) {
  if (typeof value === "string") {
    if ((0, _envSubstitutionDsepEDPS.n)(value)) output.set(path, value);
    return;
  }
  if (Array.isArray(value)) {
  ...
  if ((0, _utilsD5swhEXt.c)(value)) for (const [key, child] of Object.entries(value)) collectEnvRefPaths(child, path ? `${path}.${key}` : key, output);
}
function resolveConfigHealthStatePath(env, homedir) {
  return _nodePath.default.join((0, _pathsC1_Y0cDn.v)(env, homedir), "logs", CONFIG_HEALTH_STATE_FILENAME);
}
...
async function writeConfigHealthState(deps, state) {
  ...
  try {
    ...
    deps.logger.warn(`Config health-state write failed: ${healthPath}: ${(0, _errorsQN8rySzW.i)(err)}`);
  }
}
...
function isUpdateChannelOnlyRoot(value) {
  ...
  if (!(0, _utilsD5swhEXt.c)(update)) return false;
...
function stampConfigVersion(cfg) {
  ...
  return {
    ...
    meta: {
      ...cfg.meta,
      lastTouchedVersion: _versionDdTF4eka.n,
      lastTouchedAt: now
    }
  };
}
function warnIfConfigFromFuture(cfg, logger) {
  ...
  if (!touched) return;
  if ((0, _version6ogXOanN.r)(_versionDdTF4eka.n, touched)) {
    if (warnedFutureTouchedVersions.has(touched)) return;
    warnedFutureTouchedVersions.add(touched);
    logger.warn(`Config was last written by a newer OpenClaw (${touched}); current version is ${_versionDdTF4eka.n}.`);
  }
}
function resolveConfigPathForDeps(deps) {
  if (deps.configPath) return deps.configPath;
  return (0, _pathsC1_Y0cDn.o)(deps.env, (0, _pathsC1_Y0cDn.v)(deps.env, deps.homedir));
}
function normalizeDeps(overrides = {}) {
  return {
    ...
    homedir: overrides.homedir ?? (() => (0, _homeDirG5LU3LmA.o)(overrides.env ?? process.env, _nodeOs.default.homedir)),
...
function maybeLoadDotEnvForConfig(env) {
  ...
  (0, _dotenvYQXomdVq.t)({ quiet: true });
}
...
async function recoverConfigFromJsonRootSuffixWithDeps(params) {
  ...
  if (!validateConfigObjectWithPlugins((0, _pluginInstallConfigMigrationQDfbwB__.n)(resolveConfigForRead(resolved, params.deps.env).resolvedConfigRaw), {
    env: params.deps.env,
...
function restoreAuthoredTildePathsForWrite(next, authored, key, home) {
  ...
  if (!(0, _utilsD5swhEXt.c)(next) || !(0, _utilsD5swhEXt.c)(authored)) return next;
  const out = { ...next };
...
function resolveConfigIncludesForRead(parsed, configPath, deps) {
  return (0, _includesCjiK0ofJ.a)(parsed, configPath, {
    readFile: (candidate) => deps.fs.readFileSync(candidate, "utf-8"),
    readFileWithGuards: ({ includePath, resolvedPath, rootRealDir }) => (0, _includesCjiK0ofJ.i)({
      includePath,
      resolvedPath,
      rootRealDir,
      ioFs: deps.fs
  ...
  }, { allowedRoots: (0, _pathsC1_Y0cDn.d)(deps.env, deps.homedir) });
}
function resolveConfigForRead(resolvedIncludes, env) {
  if (resolvedIncludes && typeof resolvedIncludes === "object" && "env" in resolvedIncludes) (0, _stateDirDotenvBPwOIUAE.i)(resolvedIncludes, env);
  const envWarnings = [];
  return {
    resolvedConfigRaw: (0, _envSubstitutionDsepEDPS.r)(resolvedIncludes, env, { onMissing: (w) => envWarnings.push(w) }),
...
async function collectInvalidConfigLegacyIssues(raw, sourceRaw) {
  if (!raw || typeof raw !== "object") return [];
  const { findDoctorLegacyConfigIssues } = await Promise.resolve().then(() => jitiImport("./legacy-config-issues-DgaYUYns.js").then((m) => _interopRequireWildcard(m)));
...
function createConfigIO(overrides = {}) {
  ...
  function finalizeLoadedRuntimeConfig(cfg) {
    ...
    (0, _stateDirDotenvBPwOIUAE.i)(cfg, deps.env);
  ...
  function migrateAndStripShippedPluginInstallConfigRecords(configRaw, options = {}) {
    const installRecords = (0, _pluginInstallConfigMigrationQDfbwB__.t)(configRaw);
    const stripped = (0, _pluginInstallConfigMigrationQDfbwB__.n)(configRaw);
    if (Object.keys(installRecords).length === 0) return { config: stripped };
    if (options.persist === false) return { config: stripped };
    try {
      const stateDir = (0, _pathsC1_Y0cDn.v)(deps.env, deps.homedir);
      const filePath = (0, _installedPluginIndexRecordsCVO2sce.i)({
        env: deps.env,
        stateDir
      });
      const previousFile = captureFileSnapshotSync(filePath);
      const existingRecords = (0, _manifestRegistryBiAsJcRZ.s)({
        env: deps.env,
        stateDir
      });
      const nextRecords = {
      ...
      if (Object.keys(installRecords).some((pluginId) => !(pluginId in existingRecords))) (0, _installedPluginIndexRecordsCVO2sce.c)(nextRecords, {
        config: coerceConfig(stripped),
        env: deps.env,
        stateDir
      });
      const rootConfigRaw = options.rootConfigRaw;
      if (rootConfigRaw !== void 0 && Object.keys((0, _pluginInstallConfigMigrationQDfbwB__.t)(rootConfigRaw)).length > 0) {
        const persistedRootParsed = (0, _pluginInstallConfigMigrationQDfbwB__.n)(rootConfigRaw);
      ...
      deps.logger.warn(`Config (${configPath}): could not migrate shipped plugins.installs records into the plugin index: ${(0, _errorsQN8rySzW.i)(err)}`);
  ...
  function ensureShippedPluginInstallConfigRecordsMigratedForWrite(snapshot) {
    const installRecords = {
      ...(0, _pluginInstallConfigMigrationQDfbwB__.t)(snapshot.sourceConfig),
      ...(0, _pluginInstallConfigMigrationQDfbwB__.t)(snapshot.parsed)
    };
    ...
    try {
      (0, _installedPluginIndexRecordsCVO2sce.c)({
        ...installRecords,
        ...existingRecords
      }, {
        config: coerceConfig((0, _pluginInstallConfigMigrationQDfbwB__.n)(snapshot.sourceConfig)),
        env: deps.env,
        stateDir
      });
      return {
      ...
      throw new Error(`Config write blocked: shipped plugins.installs records in ${configPath} could not be migrated into the plugin index. Fix state directory permissions or run openclaw plugins registry --refresh, then retry. ${(0, _errorsQN8rySzW.i)(err)}`, { cause: err });
    }
  }
  ...
  function loadConfig() {
    try {
      ...
      const loadValidationPluginMetadataSnapshot = (config) => {
        ...
        pluginMetadataSnapshot = (0, _pluginMetadataSnapshotMEvRUosy.r)({
          config,
          workspaceDir: (0, _agentScopeB6RIBoEj.x)(config, (0, _agentScopeB6RIBoEj.S)(config)),
          env: deps.env
        });
      ...
      if (validated.warnings.length > 0) {
        const details = validated.warnings.map((iss) => `- ${(0, _safeTextBe5ocph.t)(iss.path || "<root>")}: ${(0, _safeTextBe5ocph.t)(iss.message)}`).join("\n");
  ...
  async function readConfigFileSnapshotInternal(options = {}) {
    ...
    try {
      ...
      try {
        ...
        const message = err instanceof _includesCjiK0ofJ.n ? err.message : `Include resolution failed: ${String(err)}`;
  ...
  async function readSourceConfigBestEffort() {
    ...
    try {
      ...
      return coerceConfig((0, _pluginInstallConfigMigrationQDfbwB__.n)(resolveConfigForRead(resolved, deps.env).resolvedConfigRaw));
    } catch {
      return {};
    }
  }
  async function writeConfigFile(cfg, options = {}) {
    ...
    if (snapshot.valid && snapshot.exists) {
      ...
      try {
        const resolvedIncludes = (0, _includesCjiK0ofJ.a)(snapshot.parsed, configPath, {
          readFile: (candidate) => deps.fs.readFileSync(candidate, "utf-8"),
          readFileWithGuards: ({ includePath, resolvedPath, rootRealDir }) => (0, _includesCjiK0ofJ.i)({
            includePath,
            resolvedPath,
...
function registerConfigWriteListener(listener) {
  return (0, _runtimeSnapshotDFDX1J4B.d)(listener);
}
...
function projectConfigOntoRuntimeSourceSnapshot(config) {
  ...
  return coerceConfig((0, _mergePatchC3PIQ2jH.t)(coerceConfig(projectSourceOntoRuntimeShape(runtimeConfigSourceSnapshot, runtimeConfigSnapshot)), createMergePatch(runtimeConfigSnapshot, config)));
}
function loadConfig() {
  return (0, _runtimeSnapshotDFDX1J4B.l)(() => createConfigIO().loadConfig());
}
...
async function writeConfigFile(cfg, options = {}) {
  ...
  if (hadBothSnapshots) nextCfg = coerceConfig((0, _mergePatchC3PIQ2jH.t)(runtimeConfigSourceSnapshot, createMergePatch(runtimeConfigSnapshot, cfg)));
  ...
  if (options.skipRuntimeSnapshotRefresh && !hadRuntimeSnapshot && !(0, _runtimeSnapshotDFDX1J4B.o)()) return;
