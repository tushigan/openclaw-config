...
function createPluginModuleLoader(options) {
  ...
  const createLoaderForModule = (modulePath) => {
    return (0, _pluginModuleLoaderCacheB600Kx.n)({
      cache: moduleLoaders,
      modulePath,
      importerUrl: "file:///opt/homebrew/lib/node_modules/openclaw/dist/loader-B-GXgDrk.js",
      loaderFilename: modulePath,
      aliasMap: (0, _sdkAliasDiiCKlea.t)(modulePath, process.argv[1], "file:///opt/homebrew/lib/node_modules/openclaw/dist/loader-B-GXgDrk.js", options.pluginSdkResolution),
