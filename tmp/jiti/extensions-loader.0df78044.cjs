...
const _require = (0, _nodeModule.createRequire)("file:///opt/homebrew/lib/node_modules/openclaw/node_modules/@mariozechner/pi-coding-agent/dist/core/extensions/loader.js");
/**
...
function getAliases() {
  if (_aliases)
  return _aliases;
  const __dirname = path.dirname((0, _nodeUrl.fileURLToPath)("file:///opt/homebrew/lib/node_modules/openclaw/node_modules/@mariozechner/pi-coding-agent/dist/core/extensions/loader.js"));
...
async function loadExtensionModule(extensionPath) {
  const jiti = (0, _jiti.createJiti)("file:///opt/homebrew/lib/node_modules/openclaw/node_modules/@mariozechner/pi-coding-agent/dist/core/extensions/loader.js", {
    moduleCache: false,
