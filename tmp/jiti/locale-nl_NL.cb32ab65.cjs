"use strict";Object.defineProperty(exports, "__esModule", { value: true });exports.nl_NL = nl_NL; // deno-fmt-ignore-file
// deno-coverage-ignore-start
/** Dutch (Netherlands) - ISO 639-1 language code 'nl' with ISO 3166-1 alpha-2 country code 'NL' for Netherlands. */
function nl_NL(error) {
...
// deno-coverage-ignore-stop /* v9-cf45a339db38b3e9 */
