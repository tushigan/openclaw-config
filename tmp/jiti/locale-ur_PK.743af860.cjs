"use strict";Object.defineProperty(exports, "__esModule", { value: true });exports.ur_PK = ur_PK; // deno-fmt-ignore-file
// deno-coverage-ignore-start
/** Urdu (Pakistan) - ISO 639-1 language code 'ur' with ISO 3166-1 alpha-2 country code 'PK' for Pakistan. */
function ur_PK(error) {
...
// deno-coverage-ignore-stop /* v9-3863ef0f13aa7336 */
