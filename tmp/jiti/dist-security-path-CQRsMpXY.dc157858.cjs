"use strict";Object.defineProperty(exports, "__esModule", { value: true });exports.n = canonicalizePathForSecurity;exports.r = canonicalizePathVariant;exports.t = void 0;var _stringCoerceBje8XVt = require("./string-coerce-Bje8XVt9.js");
...
function normalizePathForSecurity(pathname) {
  return normalizePathSeparators((0, _stringCoerceBje8XVt.a)(resolveDotSegments(pathname))) || "/";
}
...
function canonicalizePathForSecurity(pathname) {
  ...
  return {
    ...
    decodePassLimitReached,
    malformedEncoding,
    rawNormalizedPath: normalizePathSeparators((0, _stringCoerceBje8XVt.a)(pathname)) || "/"
  };
}
const PROTECTED_PLUGIN_ROUTE_PREFIXES = exports.t = ["/api/channels"];
//#endregion /* v9-476b7fdb30f88772 */
