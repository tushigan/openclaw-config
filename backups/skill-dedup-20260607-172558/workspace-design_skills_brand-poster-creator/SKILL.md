...
python3 "${EXEC_SCRIPT}" --project-dir "${PROJECT_DIR}" --size 2160x3840 --aspect 9:16 --model gpt-image-2-pro --count "${DRAW_COUNT}"
```
...
- `DRAW_COUNT` 来自 Step 6 的用户确认：默认 `1`，最多 `10`；用户要求超过 `10` 时写入 `10`
